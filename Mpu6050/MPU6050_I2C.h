...
#define MPU6050_IIC_SCL_Pin                GPIO_Pin_15	         //PB10
#define MPU6050_IIC_SDA_Pin                GPIO_Pin_14	         //PB11

#define	MPU6050_IIC_SCL                    PBout(15)
#define	MPU6050_IIC_SDA                    PBout(14)  
#define	MPU6050_IIC_SDA_IN                 PBin(14)              //读数据端口
